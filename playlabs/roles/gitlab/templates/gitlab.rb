...
gitlab_rails['gitlab_email_display_name'] = 'Git@YourLabs'
...
# gitlab_rails['smtp_address'] = "{{ mail_dns }}"
# gitlab_rails['smtp_port'] = 465
# gitlab_rails['smtp_user_name'] = "{{ gitlab_email }}"
# gitlab_rails['smtp_password'] = "{{ gitlab_email_password }}"
# gitlab_rails['smtp_domain'] = "{{ mail_dns }}"
...
nginx['ssl_certificate'] = "/etc/letsencrypt/live/{{ gitlab_dns }}/cert.pem"
nginx['ssl_certificate_key'] = "/etc/letsencrypt/live/{{ gitlab_dns }}/key.pem"
...
# pages_external_url "https://{{ gitlab_pages_dns }}/"
